      ...
      <div className="w-full">
        ...
        >
          ...
          <input
            ...
            className={cn(
              "flex h-[30px] md:h-[35px] lg:h-[40px] w-full placeholder-shown:text-[#525252B2] file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-[#525252B2] placeholder:font-light focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 text-sm font-geologica",
              rightIcon ? "pr-3" : "",
              leftIcon ? "pl-3" : "",
              inputClassName,
            )}
