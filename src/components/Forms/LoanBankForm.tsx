...
const LoanBankFormSchema = z.object({
...
export type TypeLoanBankFormSchema = z.infer<typeof LoanBankFormSchema>;

interface LoanBankFormProps {
  onCancel: () => void;
  onSubmit: (data: TypeLoanBankFormSchema) => void;
}

const LoanBankForm = ({ onCancel, onSubmit }: LoanBankFormProps) => {
  const [isSubmitting, setIsSubmitting] = useState(false);

  const form = useForm<TypeLoanBankFormSchema>({
    resolver: zodResolver(LoanBankFormSchema),
    defaultValues: {
      bvn: "",
      bankName: "",
      accountNumber: "",
  ...
  const handleFormSubmit = async (data: TypeLoanBankFormSchema) => {
