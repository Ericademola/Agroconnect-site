...
export const ProductsInDemands = () => {
  return (
    <div className="flex flex-col gap-[30px]">
      ...
      <Catalogue category="inDemand" sliceLimit={4} />
    </div>
  );
};

export const SpecialRequestProducts = () => {
  return (
    <div className="flex flex-col gap-[30px]">
      <div className="flex items-center justify-between">
        <h2 className="text-[#000000CC] text-[clamp(16px,2.9vw,32px)] font-geologica font-semibold ">
      ...
      <Catalogue category="special" sliceLimit={4} />
    </div>
  );
};
...
export const ByProducts = () => {
  return (
    <div className="flex flex-col gap-[30px]">
      ...
      <Catalogue category="byProducts" sliceLimit={4} />
    </div>
  );
};
