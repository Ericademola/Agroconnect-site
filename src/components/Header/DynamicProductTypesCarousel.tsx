    ...
    <div className={`relative w-full py-2 bg-white ${pageScrolled && "border-b border-gray-200 shadow-lg"}`}>
        ...
        <div className="relative w-full">
            <div className="overflow-hidden px-8" ref={emblaRef}>
                ...
                {productTypes.map((productType: IProductTypeItem, index: number) => (
                    ...
                    >
                        ...
                        <div className="pt-[8px] text-[24px] w-fit m-auto">{productType.icon}</div>
                        <span className="whitespace-nowrap">{productType.label}</span>
                        </div>
                    </Link>
                    </div>
                ))}
