...
const PageTitle = ({ title, description }: IpageTitleProps) => {
  return (
    <div className="bg-[url('/shopBg.png')] bg-no-repeat bg-cover bg-center w-full min-h-[180px] text-white ">
      <div className="pl-4 sm:pl-5 md:pl-6 ml:pl-8 lg:pl-12 pt-20">
